...
type BlogPost = {
  ...
  publishedAt: string;
  coverImage?: string;
  content: any[]; // or use your actual Block type if typed
  likes?: number;
};
...
// Pre-render blog pages for each slug
...
// ✅ FIXED: Await the async `params` object properly
export default async function BlogPost({
  ...
  console.log("Fetched post:", post); // 👈 Add this here to inspect content in the terminal

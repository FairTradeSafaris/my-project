...
type Block =
  | { _type: "heroImage"; image: any; text?: string; alignment?: string }
  | { _type: "textImage"; image: any; text: string; align?: "left" | "right" }
  | { _type: "quoteBlock"; quote: string; attribution?: string }
  | { _type: "textBlock"; body: any[] }
  | { _type: "videoEmbed"; url: string }
  | {
      _type: "ctaBlock";
      headline: string;
      subtext: string;
  ...
  | { _type: "mapBlock"; mapUrl: string }
  | { _type: "zohoForm"; iframeUrl: string; height?: number }
  | { _type: "galleryBlock"; images: any[] }
  | {
      _type: "smartCarousel";
      slides: {
        image: any;

        ...
        switch (block._type) {
              ...
              <section key={index} className="relative text-center">
                {block.image && (
                  <Image
                    ...
                    width={1600}
                    height={300} // smaller banner height
                ...
                {block.text && (
                  ...
                  >
                    <h2 className="text-5xl font-extrabold text-white bg-black/60 p-6 rounded">
                      {block.text}
                    </h2>
                  </div>
                )}
          ...
          case "textImage":
            ...
            return (
              <section
                key={index}
                className={`max-w-3xl mx-auto px-6 flex flex-col md:flex-row ${
          ...
          case "textBlock":
            return (
              <section key={index} className="max-w-5xl mx-auto px-6 py-0">
                <div className="w-full text-lg text-gray-800 leading-relaxed space-y-4">
                  {block.body.map((pt, i) => (

              ...
              <div key={index} className="w-full flex justify-center">
                ...
                >
                  <iframe
                    ...
                    allowFullScreen
                  />
                  <div className="absolute inset-0 bg-black/30 hover:bg-black/50 transition rounded" />
                </div>
                ...
                <Modal
                  ...
                  className="w-full max-w-5xl mx-auto my-20 bg-white rounded overflow-hidden"

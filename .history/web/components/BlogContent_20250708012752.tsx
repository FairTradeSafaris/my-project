...
import Modal from "react-modal"; // make sure this package is installed
          ...
          case "videoEmbed": {
            ...
            return (
              <div key={index} className="w-full flex justify-center">
                {/* Thumbnail-size embed */}
                <div
                  className="relative w-full max-w-md cursor-pointer aspect-video"
                ...
                >
                  <iframe
                    ...
                    allowFullScreen
                  />
                  <div className="absolute inset-0 bg-black/30 hover:bg-black/50 transition rounded flex items-center justify-center">
                ...
                <Modal
                  ...
                  className="w-full max-w-5xl mx-auto my-20 bg-white rounded overflow-hidden relative p-4"

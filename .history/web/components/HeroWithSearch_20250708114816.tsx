    ...
    <section className="relative min-h-[90vh] w-full pt-24 md:pt-28 overflow-hidden">
      ...
      <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-4">
        ...
        <form
          ...
          className="bg-white/20 backdrop-blur-md text-white rounded-2xl px-4 py-4 shadow-2xl flex flex-col md:flex-row items-stretch gap-3 w-full max-w-4xl border border-white/20"
        >
          {/* Where To */}
          <div className="flex items-center gap-2 border border-black/10 rounded-xl px-4 py-3 w-full bg-white/50 hover:bg-white/60 transition backdrop-blur-md">
          ...
          {/* Destination Select */}
          <div className="flex items-center gap-2 border border-white/20 rounded-xl px-4 py-3 w-full bg-white/10 hover:bg-white/20 transition backdrop-blur-md">
            <MapPin className="w-5 h-5 text-white/90" />
            <select
              className="bg-transparent outline-none text-sm w-full text-white placeholder-white/90 appearance-none"
              defaultValue=""
            >
          ...
          <div className="flex items-center gap-2 border border-white/20 rounded-xl px-4 py-3 w-full bg-white/10 hover:bg-white/20 transition backdrop-blur-md">
            ...
            <input
              type="text"
              placeholder="Guests"
              className="bg-transparent outline-none text-sm w-full placeholder-white/90 text-white"
            />
          </div>
          ...
          <button
            ...
            className="bg-white text-black rounded-2xl px-6 py-3 font-semibold hover:bg-gray-100 shadow-md transition text-sm w-full md:w-auto flex items-center justify-center"
          >

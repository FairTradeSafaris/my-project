...
type Props = {
  ...
  isFeatured?: boolean; // 🆕 conditional badge
};
  ...
  return (
    <div className="relative w-full max-w-sm overflow-visible pb-40 bg-transparent">
      ...
      <div className="relative">
        ...
        {/* 🟥 Featured Badge */}
        {isFeatured && (
          <div className="absolute top-2 left-[-22px] transform -rotate-30 bg-red-600 text-white text-[12px] font-bold px-8 py-0.5 z-20 shadow-md tracking-wide">
            Featured
          </div>
        )}
      </div>

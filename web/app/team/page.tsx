...
export default async function TeamPage() {
  ...
  return (
    <main className="bg-background text-foreground   min-h-screen font-sans">
      ...
      <section className="px-6 py-20 bg-[#f8f2eb]  transition-colors duration-500">
        <div className="max-w-6xl mx-auto">
          {/* Line Art + Editable Heading */}
          <div className="text-center mb-16">
            <div className="mx-auto w-72 md:w-80 lg:w-96 relative h-20 opacity-90 mb-4 ">
              <Image
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {team.map((member) => (
              <div
                key={member._id}
                className="bg-white  rounded-xl shadow-sm overflow-hidden border border-[#e4d6c4]  transition hover:shadow-md"
              >
                <div
                ...
                <div className="flex flex-col items-center text-center px-6 -mt-12 pb-6">
                  <div className="w-28 h-28 relative rounded-full border-4 border-white  shadow-md overflow-hidden">
                    <Image
                      src={member.image}
                      alt={member.name}
                      fill
                  ...
                  <h4 className="mt-6 text-lg font-semibold text-[#3c2a1e]  leading-tight">
                    {member.name}
                  </h4>
                  ...
                  <div className="flex gap-4 mt-4 text-[#3c2a1e] ">
                    {member.email && (
